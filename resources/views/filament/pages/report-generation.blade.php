                                    ...
                                    @foreach ($this->scheduledPlans as $plan)
                                        <tr
                                            ...
                                            <td class="px-4 py-4 text-right">
                                                <button type="button"
                                                    class="text-on-surface-variant transition-colors hover:text-primary dark:text-slate-400">✎</button>
                                                <button type="button"
                                                    class="ml-2 text-on-surface-variant transition-colors hover:text-error dark:text-slate-400">🗑</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>

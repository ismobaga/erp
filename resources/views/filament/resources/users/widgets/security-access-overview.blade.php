    ...
    <div class="grid gap-8 xl:grid-cols-12">
        <section class="architectural-card xl:col-span-8">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <p class="text-[10px] font-black uppercase tracking-[0.24em] text-[#43474e]">Security log</p>
                    <h3 class="text-2xl font-black tracking-[-0.02em] text-[#002045]">Recent access activity</h3>
                </div>
                <span
                    class="rounded-full bg-[#eff4ff] px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#002045]">Live</span>
            </div>
        ...
        <section class="architectural-card xl:col-span-4 bg-[#eff4ff]/65">
            <div class="space-y-4">
                <div class="rounded-2xl bg-white p-4">
                    <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[#43474e]">Active personnel</p>
                ...
                <div class="rounded-2xl bg-[linear-gradient(135deg,#003d36_0%,#005048_100%)] p-4 text-white">
                    <p class="text-[10px] font-black uppercase tracking-[0.18em] text-white/70">MFA compliance</p>
                    <p class="mt-2 text-4xl font-black text-[#8df5e4]">{{ $metrics['mfa_compliance'] }}</p>
                </div>
                <div class="rounded-2xl bg-white p-4">
                    <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[#43474e]">Pending revocations</p>

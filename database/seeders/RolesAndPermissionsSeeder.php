...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            'invoices.view', 'invoices.create', 'invoices.update', 'invoices.delete', 'invoices.record_payment',
        ...
        $finance->syncPermissions(Permission::whereIn('name', [
            'clients.view',
            'quotes.view',
            'invoices.view', 'invoices.create', 'invoices.update', 'invoices.record_payment',
            'payments.view', 'payments.create', 'payments.update', 'payments.delete',
            'expenses.view', 'expenses.create', 'expenses.update', 'expenses.delete',
            'reports.view',
        ])->get());

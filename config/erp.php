        ...
        'profiles' => [
            ...
            'simple' => [
                'enabled_modules' => array_values(array_filter(array_map(
                    ...
                    explode(',', (string) env('ERP_SIMPLE_ENABLED_MODULES', 'dashboard,clients,invoices,payments,expenses'))
                ))),
            ],
            'growing' => [
                'enabled_modules' => array_values(array_filter(array_map(
                    static fn (string $module): string => trim(strtolower($module)),
                    explode(',', (string) env('ERP_GROWING_ENABLED_MODULES', 'dashboard,clients,invoices,payments,expenses'))
                ))),
            ],
        ],
        'scope_to_module' => [
